def train_mc(headless=True):
    ...
    from mini_gym.envs.vision60.vision60_config import config_vision60
    # seems below doesn't work if we try to manually add a velocity tracking script for vision60
    ...
    RunnerArgs.save_video_interval = 50
